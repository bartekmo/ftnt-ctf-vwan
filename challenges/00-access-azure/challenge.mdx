...
In a new browser tab open the shared FortiManager UI <EnvVar label="FortiManager UI" field="fmg" />
...
> **Verify:** you can access (only) ADOM named after your hub. You should see one FortiGate there.
