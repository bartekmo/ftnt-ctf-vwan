...
![Resource group in Azure portal](student-rg.png)

## FortiManager

In a new browser tab open the shared FortiManager UI 
<EnvVar label="FortiManager UI" field="fmg_ip" prefix="https://" link />

Accept the certificate warning and log in using your username and password visible in My Environment.

> **Verify:** you should see only the ADOM named after your hub with one FortiGate in it.

![FortiManager](fmg.png)
...
<EnvVar field="branch_fgt_pip" label="Branch FortiGate PIP" prefix="https://" link />
...
The credentials are the same as for FortiManager and branch FortiGate.

<EnvVar field="branch_win_pip" label="Winows desktop" />

![Branch Windows desktop](windows.png)
